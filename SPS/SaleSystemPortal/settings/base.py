...
OSCAR_DASHBOARD_NAVIGATION = [
    {
        'label': _('Dashboard'),
        'icon': 'fas fa-list',
        'url_name': 'catalogue-product-list',
    },
    {
        'label': _('Catalogue'),
        'icon': 'fas fa-sitemap',
        'children': [
            ...
            },
            {
                ...
                'url_name': 'catalogue-class-list',
            },
            {
                'label': _('Categories'),
                'url_name': 'catalogue-category-list',
            },
            {
                'label': _('Ranges'),
                'url_name': 'range-list',
            },
            {
                ...
                'url_name': 'stock-alert-list',
            },
            {
                'label': _('Options'),
                'url_name': 'catalogue-option-list',
            },
        ]
    },
    {
        ...
        'children': [
            ...
            {
                'label': _('Statistics'),
                'url_name': 'order-stats',
            },
            {
                'label': _('Partners'),
                'url_name': 'partner-list',
            },
    ...
    },
    {
        ...
        'children': [
            ...
            {
                'label': _('Vouchers'),
                'url_name': 'voucher-list',
            },
            {
                'label': _('Voucher Sets'),
                'url_name': 'voucher-set-list',
            },
