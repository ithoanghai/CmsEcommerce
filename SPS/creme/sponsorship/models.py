...
class Sponsor(models.Model):
    ...
    web_logo_benefit = models.BooleanField(_("Web logo benefit"), null=True, help_text=_(u"Web logo benefit is complete"))
    print_logo_benefit = models.BooleanField(_("Print logo benefit"),null=True, help_text=_(u"Print logo benefit is complete"))
    print_description_benefit = models.BooleanField(_("Print description benefit"),null=True, help_text=_(u"Print description benefit is complete"))
    company_description_benefit = models.BooleanField(_("Company description benefit"),null=True, help_text=_(u"Company description benefit is complete"))
...
class SponsorBenefit(models.Model):
    ...
    is_complete = models.BooleanField(_("Complete?"), null=True, help_text=_(u"True - benefit complete; False - benefit incomplete; Null - n/a"))
