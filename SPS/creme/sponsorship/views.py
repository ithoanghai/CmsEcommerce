...
from ..sponsorship.models import Benefit, Sponsor, SponsorBenefit, \
    SponsorLevel
...
def sponsor_apply(request):
    ...
    return render(request,"app_list/sponsorship/apply.html", context)
...
def sponsor_add(request):
    ...
    return render(request, "app_list/sponsorship/add.html", context)
...
def sponsor_detail(request, pk):
    ...
    return render(request, "app_list/sponsorship/detail.html", context)
