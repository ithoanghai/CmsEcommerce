...
from ..models import InvitationStat

register = template.Library()


@register.inclusion_tag("app_list/invitations/_invites_remaining.html")
...
@register.inclusion_tag("app_list/invitations/_invite_form.html")
def invite_form(user):
    return {"form": InviteForm(user=user), "user": user}


@register.inclusion_tag("app_list/invitations/_invited.html")
