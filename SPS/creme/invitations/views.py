...
class InviteView(LoginRequiredMixin, FormMixin, View):
    ...
    invite_form_fragment = "app_list/invitations/_invite_form.html"
    invites_remaining_fragment = "app_list/invitations/_invites_remaining.html"
    invited_fragment = "app_list/invitations/_invited.html"
    invites_remaining_fragment_selector = ".invitations-invites-remaining"
    invited_fragment_selector = ".invitations-invites-sent"
...
class ManageInvitesView(LoginRequiredMixin, View):
    ...
    @method_decorator(permission_required("invitations.manage_invites", raise_exception=True))
