...
from ..customer.utils import get_password_reset_url
from ..creme_core.core.compat import get_user_model
from ..creme_core.core.loading import (
    get_class, get_classes, get_model, get_profile_class)
from ..creme_core.core.utils import safe_referrer
from ..creme_core.views.generic.base import PostActionMixin
...
class EmailHistoryView(PageTitleMixin, generic.ListView):
    ...
    def get_queryset(self):
        """
        Return Queryset of :py:class:`Email <creme.customer.abstract_models.AbstractEmail>`
...
class OrderHistoryView(PageTitleMixin, generic.ListView):
    ...
    def get_queryset(self):
        """
        Return Queryset of :py:class:`Order <creme.order.abstract_models.AbstractOrder>`
