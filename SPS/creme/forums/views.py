...
class ForumsView(ListView):
    ...
    model = Forum
    template_name = "app_list/forums/forums.html"
...
class ForumCategoryView(DetailView):
    ...
    template_name = "app_list/forums/category.html"
...
class ForumView(DetailView):
    ...
    template_name = "app_list/forums/forum.html"
...
class ForumThreadView(FormView, DetailView):
    ...
    template_name = "app_list/forums/thread.html"
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse("forums:thread", args=[self.object.pk]))
...
class PostCreateView(LoginRequiredMixin, FormView, DetailView):
    ...
    template_name = "app_list/forums/post_create.html"
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.object.closed:
            ...
            return HttpResponseRedirect(reverse("forums:forum", args=[self.object.id]))
...
class ForumThreadReplyCreateView(LoginRequiredMixin, FormView, DetailView):
    ...
    model = ForumThread
    context_object_name = "thread"
    template_name = "app_list/forums/reply_create.html"
    form_class = ReplyForm
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if self.object.closed:
            ...
            return HttpResponseRedirect(reverse("forums:thread", args=[self.object.id]))
...
class PostEditView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse("forums:thread", args=[self.thread_id])
...
class SubscribeView(LoginRequiredMixin, DetailView):
    ...
    model = ForumThread
    context_object_name = "thread"
    template_name = "app_list/forums/subscribe.html"
...
class UnsubscribeView(LoginRequiredMixin, DetailView):
    ...
    model = ForumThread
    context_object_name = "thread"
    template_name = "app_list/forums/unsubscribe.html"
...
class ThreadUpdatesView(LoginRequiredMixin, ListView):
    ...
    template_name = "app_list/forums/thread_updates.html"
