...
class InboxView(TemplateView):
    ...
    """
    template_name = "app_list/messages/inbox.html"
...
class ThreadView(UpdateView):
    ...
    template_name = "app_list/messages/thread_detail.html"
    success_url = reverse_lazy("messages:inbox")
...
class MessageCreateView(CreateView):
    ...
    """
    template_name = "app_list/messages/message_create.html"
...
class ThreadDeleteView(DeleteView):
    ...
    model = Thread
    success_url = reverse_lazy("messages:inbox")
    template_name = "app_list/messages/thread_confirm_delete.html"
