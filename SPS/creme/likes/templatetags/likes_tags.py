...
def likes(user, *models):
    ...
    """
    content_types = []
    model_list = models or settings.LIKES_LIKABLE_MODELS.keys()
...
def likes_widget(context, user, obj, template_name="app_list/likes/_widget.html"):
    """
    Usage:

        {% likes_widget request.user post %}
    or
        {% likes_widget request.user post "app_list/likes/_widget_brief.html" %}
    """
...
class LikeRenderer(template.Node):
    ...
    def render(self, context):
        ...
        return render_to_string([
            f"app_list/likes/{app_name}/{model_name}.html",
            f"app_list/likes/{app_name}/like.html",
