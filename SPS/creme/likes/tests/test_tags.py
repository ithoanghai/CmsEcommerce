...
from ..templatetags.likes_tags import ObjectDecorator
from ..templatetags.likes_tags import likes as likes_tag
from ..templatetags.likes_tags import likes_count as likes_count_tag
from ..templatetags.likes_tags import who_likes as who_likes_tag
...
class ObjectDecoratorTestCase(TestCase):
    ...
    def test_likes_specific(self):
        likes = likes_tag(self.user, "accounts.User")
