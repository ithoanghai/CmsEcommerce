...
from ...badges.base import Badge, BadgeAwarded
from ...badges.registry import badges
from ...badges.templatetags import badges_tags
...
class TemplateTagsTests(TestCase):
    ...
    def test_badge_count(self):
        self.assertEqual(badges_tags.badge_count(self.user), 1)

    def test_badges_for_user(self):
        self.assertEqual(badges_tags.badges_for_user(self.user).count(), 1)
...
class TasksTestCase(TestCase):
    ...
    def test_import_without_celery(self):
        ...
        try:
            ...
            self.fail("Importing badges.tasks without celery installed should not fail")
