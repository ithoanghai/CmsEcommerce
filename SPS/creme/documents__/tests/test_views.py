...
class TestFolders(BaseTest):
    ...
    def test_delete(self, mock_messages):
        ...
        with self.login(self.user):
            ...
            self.response_200(response)
            self.assertTrue("app_list/documents/folder_confirm_delete.html" in response.template_name)
...
class TestDocuments(BaseTest):
    ...
    def test_valid_delete(self, mock_messages):
        ...
        with self.login(self.user):
            ...
            self.response_200(response)
            self.assertTrue("app_list/documents/document_confirm_delete.html" in response.template_name)
