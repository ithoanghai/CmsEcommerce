...
class ChatConsumer(WebsocketConsumer):
    ...
    def fetch_messages(self, data):
        author = CremeUser.objects.get(username=data['author'])
        friend = CremeUser.objects.get(username=data['friend'])
    ...
    def new_message(self, data):
        author = data['from']
        friend = data['friend']
        author_user = CremeUser.objects.filter(username=author)[0]
        friend_user = CremeUser.objects.filter(username=friend)[0]
    ...
    def connect(self):
        ...
        author_user = CremeUser.objects.filter(username=self.user.username)[0]
        friend_user = CremeUser.objects.filter(username=self.friend_name)[0]
