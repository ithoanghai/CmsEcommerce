...
from ...creme_core.tests import fake_constants
from ...creme_core.tests.fake_models import (
    FakeContact,
    FakeInvoice,
    FakeOrganisation,
)
...
from ...reports.bricks import (
    InstanceBricksInfoBrick,
    ReportGraphChartBrick,
    ReportGraphChartInstanceBrick,
    ReportGraphChartListBrick,
)
from ...reports.constants import RGF_FK, RGF_NOLINK, RGF_RELATION
from ...reports.core.graph.fetcher import (
    RegularFieldLinkedGraphFetcher,
    SimpleGraphFetcher,
)
from ...reports.core.graph.hand import _generate_date_format
from ...reports.report_chart_registry import report_chart_registry
from ...reports.tests.base import BaseReportsTestCase
from ...reports.tests.fake_models import (
    FakeReportsDocument,
    FakeReportsFolder,
)
