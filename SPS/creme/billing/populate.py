...
from .. import billing, persons, products
...
class Populator(BasePopulator):
    ...
    def populate(self):
        ...
        if 'creme.billing.exporters.xhtml2pdf.Xhtml2pdfExportEngine' in settings.BILLING_EXPORTERS:
            from ..billing.exporters.xhtml2pdf import Xhtml2pdfExportEngine
            from ..creme_core.utils import l10n
    ...
    def create_reports(self,
        ...
        from .. import reports
        from ..reports.constants import RFT_FIELD, RFT_RELATION
        from ..reports.core.graph.fetcher import SimpleGraphFetcher
