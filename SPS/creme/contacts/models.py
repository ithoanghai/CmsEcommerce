...
class Contact(models.Model):
    ...
    #created_by = models.ForeignKey(Profile, related_name="contact_created_by", on_delete=models.SET_NULL, null=True )
    created_by = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='contact_created_by', null=True)
