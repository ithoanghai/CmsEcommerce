...
def image_upload_to(instance, filename):
    ...
    return f"images/image-set-{instance.image_set.pk}/{uid}.{ext}"
...
class ImageSet(models.Model):
    ...
    class Meta:
        app_label = 'images'  # Sử dụng tên của ứng dụng chứa model
    ...
    def image_data(self):
        return {
            ...
            "upload_url": reverse("images:imageset_upload", args=[self.pk])
        }
...
class Image(models.Model):
    ...
    thumbnail = ImageSpecField(source="image", id="images:image:thumbnail")
    list_thumbnail = ImageSpecField(source="image", id="images:image:list_thumbnail")
    small_thumbnail = ImageSpecField(source="image", id="images:image:small_thumbnail")
    medium_thumbnail = ImageSpecField(source="image", id="images:image:medium_thumbnail")
    ...
    def data(self):
        return {
            ...
            "delete_url": reverse("images:image_delete", args=[self.pk]),
            "make_primary_url": reverse("images:image_make_primary", args=[self.pk])
        }
