...
from ...creme_core.http import is_ajax
from ...creme_core.models import Relation, RelationType, SettingValue, Vat
from ...creme_core.views.generic import base
from ...creme_core.views.relation import RelationsObjectsSelectionPopup
from ...persons import workflow
