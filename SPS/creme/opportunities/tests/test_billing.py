...
from ...opportunities import constants
from ...persons.constants import REL_SUB_CUSTOMER_SUPPLIER, REL_SUB_PROSPECT
from ...persons.tests.base import skipIfCustomOrganisation
...
if apps.is_installed('creme.billing'):
    ...
    from ...billing.models import QuoteStatus
