...
from ....creme_core.global_info import set_global_info
...
class EntityFiltersTestCase(CremeTestCase):
    ...
    def test_manager_smart_update_or_create_again05(self):
        ...
        self.assertEqual(f'{pk}[{VERSION}]', efilter2.pk)
        self.assertEqual(f'Nerv member [{VERSION}]', efilter2.name)
        ...
        self.assertEqual(f'{pk}[{VERSION}]2', efilter3.pk)
        self.assertEqual(f'Nerv member [{VERSION}](2)', efilter3.name)

        # --------------------------
        efilter4 = create_filter(use_or=True, value='Katsuragi')
        self.assertEqual(4, qs.count())
        self.assertEqual(f'{pk}[{VERSION}]3', efilter4.pk)
        self.assertEqual(f'Nerv member [{VERSION}](3)', efilter4.name)
