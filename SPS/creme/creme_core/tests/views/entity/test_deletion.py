...
from ....bricks import EntityJobErrorsBrick, TrashBrick
from ....creme_jobs import reminder_type, trash_cleaner_type
from ....models import (
    CremeEntity,
    CremeProperty,
    CremePropertyType,
...
class EntityViewsTestCase(BrickTestCaseMixin, ViewsTestCase):
    ...
    def test_delete_dependencies_to_str(self):
        from ..creme_core.views.entity import EntityDeletionMixin
