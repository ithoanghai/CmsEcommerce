...
from ...forms import listview as lv_forms
from ...core.entity_cell import (
    EntityCellCustomField,
    EntityCellRegularField,
    EntityCellRelation,
)
from ...core.enumerable import QSEnumerator, _EnumerableRegistry
from ...gui.listview import ListViewSearchFieldRegistry
from ...models import (
    CustomField,
...
class SearchFieldsTestCase(CremeTestCase):
    ...
    def test_propertiesfield(self):
        from ..core.entity_cell import EntityCellFunctionField
        from ..function_fields import PropertiesField
        from ..models import CremePropertyType
