...
from ..factories.utils import tax_add, tax_subtract
...
class BillingAddressFactory(factory.django.DjangoModelFactory):
    country = factory.SubFactory('creme.test.factories.CountryFactory')
...
class OrderFactory(factory.django.DjangoModelFactory):
    ...
    basket = factory.SubFactory(
        'creme.test.factories.BasketFactory')
...
class OrderLineFactory(factory.django.DjangoModelFactory):
    ...
    product = factory.SubFactory(
        'creme.test.factories.ProductFactory')
