...
from ...gui import listview  as lv_gui
...
from ...models.entity_filter import (
    EntityFilter,
    EntityFilterList,
)
from ...models.header_filter import (
    HeaderFilter,
    HeaderFilterList,
)
from ...utils import get_from_GET_or_404, get_from_POST_or_404
...
class BaseEntitiesListPopup(EntitiesList):
    ...
    def handle_no_header_filter(self, request):
        ...
        return HttpResponse(
            _('The desired list does not have any view, please create one.'),
        )
