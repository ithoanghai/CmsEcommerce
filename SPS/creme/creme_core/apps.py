...
class CremeCoreConfig(CremeAppConfig):
    ...
    def hook_fk_formfield():
        ...
        from ..creme_config.forms import fields as config_fields
    ...
    def hook_fk_check():
        ...
        from .models.deletion import CREME_REPLACE_NULL
    ...
    def hook_m2m_formfield():
        ...
        from ..creme_config.forms.fields import (
    ...
    def hook_textfield_formfield():
        ...
        from .forms.widgets import CremeTextarea
