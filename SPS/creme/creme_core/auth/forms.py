...
from ..models import CremeUser, EmailAddress
...
USER_FIELD_MAX_LENGTH = getattr(CremeUser, CremeUser.USERNAME_FIELD).field.max_length
...
class SignupForm(forms.Form):
    ...
    password = PasswordField(
        label=_("Password"),
        strip=settings.AUTH_PASSWORD_STRIP,
    )
    ...
    def clean_username(self):
        ...
        qs = CremeUser.objects.filter(**lookup_kwargs)
        if not qs.exists():
