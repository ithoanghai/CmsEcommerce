...
class OrdersDashboardConfig(CremeCoreConfig):
    label = 'orders_dashboard'
    name = 'creme.creme_core.dashboard.orders'
    ...
    def ready(self):
        self.order_list_view = get_class('creme_core.dashboard.orders.views', 'OrderListView')
        self.order_detail_view = get_class('creme_core.dashboard.orders.views', 'OrderDetailView')
        self.shipping_address_view = get_class('creme_core.dashboard.orders.views',
                                               'ShippingAddressUpdateView')
        self.line_detail_view = get_class('creme_core.dashboard.orders.views', 'LineDetailView')
        self.order_stats_view = get_class('creme_core.dashboard.orders.views', 'OrderStatsView')
