...
from ....order import exceptions as order_exceptions
...
from ...views.generic.base import BulkEditMixin
...
OrderStatsForm = get_class('creme_core.dashboard.orders.forms', 'OrderStatsForm')
OrderSearchForm = get_class('creme_core.dashboard.orders.forms', 'OrderSearchForm')
OrderNoteForm = get_class('creme_core.dashboard.orders.forms', 'OrderNoteForm')
ShippingAddressForm = get_class('creme_core.dashboard.orders.forms', 'ShippingAddressForm')
OrderStatusForm = get_class('creme_core.dashboard.orders.forms', 'OrderStatusForm')
