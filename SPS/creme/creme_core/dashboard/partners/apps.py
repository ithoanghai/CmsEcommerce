...
class PartnersDashboardConfig(CremeCoreConfig):
    label = 'partners_dashboard'
    name = 'creme.creme_core.dashboard.partners'
    verbose_name = _('Partners dashboard')

    default_permissions = ['is_staff', ]

    def ready(self):
        self.list_view = get_class('creme_core.dashboard.partners.views', 'PartnerListView')
        self.create_view = get_class('creme_core.dashboard.partners.views', 'PartnerCreateView')
        self.manage_view = get_class('creme_core.dashboard.partners.views', 'PartnerManageView')
        self.delete_view = get_class('creme_core.dashboard.partners.views', 'PartnerDeleteView')

        self.user_link_view = get_class('creme_core.dashboard.partners.views',
                                        'PartnerUserLinkView')
        self.user_unlink_view = get_class('creme_core.dashboard.partners.views',
                                          'PartnerUserUnlinkView')
        self.user_create_view = get_class('creme_core.dashboard.partners.views',
                                          'PartnerUserCreateView')
        self.user_select_view = get_class('creme_core.dashboard.partners.views',
                                          'PartnerUserSelectView')
        self.user_update_view = get_class('creme_core.dashboard.partners.views',
