...
class OffersDashboardConfig(CremeCoreConfig):
    label = 'offers_dashboard'
    name = 'creme.creme_core.dashboard.offers'
    verbose_name = _('Offers dashboard')

    default_permissions = ['is_staff', ]

    def ready(self):
        self.list_view = get_class('creme_core.dashboard.offers.views', 'OfferListView')
        self.metadata_view = get_class('creme_core.dashboard.offers.views', 'OfferMetaDataView')
        self.condition_view = get_class('creme_core.dashboard.offers.views', 'OfferConditionView')
        self.benefit_view = get_class('creme_core.dashboard.offers.views', 'OfferBenefitView')
        self.restrictions_view = get_class('creme_core.dashboard.offers.views',
                                           'OfferRestrictionsView')
        self.delete_view = get_class('creme_core.dashboard.offers.views', 'OfferDeleteView')
        self.detail_view = get_class('creme_core.dashboard.offers.views', 'OfferDetailView')
