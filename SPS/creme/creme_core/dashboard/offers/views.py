...
MetaDataForm, ConditionForm, BenefitForm, RestrictionsForm, OfferSearchForm \
    = get_classes('creme_core.dashboard.offers.forms',
                  ['MetaDataForm', 'ConditionForm', 'BenefitForm',
                   'RestrictionsForm', 'OfferSearchForm'])
OrderDiscountCSVFormatter = get_class('creme_core.dashboard.offers.reports', 'OrderDiscountCSVFormatter')
...
class OfferWizardStepView(FormView):
    ...
    def save_offer(self, offer):
        ...
        return HttpResponseRedirect(reverse(
            'offer-detail', kwargs={'pk': offer.pk}))
...
class OfferMetaDataView(OfferWizardStepView):
    ...
    url_name = 'offer-metadata'
    success_url_name = 'offer-benefit'
...
class OfferBenefitView(OfferWizardStepView):
    ...
    url_name = 'offer-benefit'
    success_url_name = 'offer-condition'
...
class OfferConditionView(OfferWizardStepView):
    ...
    url_name = 'offer-condition'
    success_url_name = 'offer-restrictions'
