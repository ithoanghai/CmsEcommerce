...
VoucherForm = get_class('creme_core.dashboard.vouchers.forms', 'VoucherForm')
VoucherSetForm = get_class('creme_core.dashboard.vouchers.forms', 'VoucherSetForm')
VoucherSetSearchForm = get_class('creme_core.dashboard.vouchers.forms', 'VoucherSetSearchForm')
VoucherSearchForm = get_class('creme_core.dashboard.vouchers.forms', 'VoucherSearchForm')
