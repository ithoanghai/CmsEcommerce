...
class CatalogueDashboardConfig(CremeCoreConfig):
    label = 'catalogue_dashboard'
    name = 'creme.creme_core.dashboard.catalogue'
    ...
    def ready(self):
        self.product_list_view = get_class('creme_core.dashboard.catalogue.views',
                                           'ProductListView')
        self.product_lookup_view = get_class('creme_core.dashboard.catalogue.views',
                                             'ProductLookupView')
        self.product_create_redirect_view = get_class('creme_core.dashboard.catalogue.views',
                                                      'ProductCreateRedirectView')
        self.product_createupdate_view = get_class('creme_core.dashboard.catalogue.views',
                                                   'ProductCreateUpdateView')
        self.product_delete_view = get_class('creme_core.dashboard.catalogue.views',
                                             'ProductDeleteView')

        self.product_class_create_view = get_class('creme_core.dashboard.catalogue.views',
                                                   'ProductClassCreateView')
        self.product_class_update_view = get_class('creme_core.dashboard.catalogue.views',
                                                   'ProductClassUpdateView')
        self.product_class_list_view = get_class('creme_core.dashboard.catalogue.views',
                                                 'ProductClassListView')
        self.product_class_delete_view = get_class('creme_core.dashboard.catalogue.views',
                                                   'ProductClassDeleteView')

        self.category_list_view = get_class('creme_core.dashboard.catalogue.views',
                                            'CategoryListView')
        self.category_detail_list_view = get_class('creme_core.dashboard.catalogue.views',
                                                   'CategoryDetailListView')
        self.category_create_view = get_class('creme_core.dashboard.catalogue.views',
                                              'CategoryCreateView')
        self.category_update_view = get_class('creme_core.dashboard.catalogue.views',
                                              'CategoryUpdateView')
        self.category_delete_view = get_class('creme_core.dashboard.catalogue.views',
                                              'CategoryDeleteView')

        self.stock_alert_view = get_class('creme_core.dashboard.catalogue.views',
                                          'StockAlertListView')

        self.attribute_option_group_create_view = get_class('creme_core.dashboard.catalogue.views',
                                                            'AttributeOptionGroupCreateView')
        self.attribute_option_group_list_view = get_class('creme_core.dashboard.catalogue.views',
                                                          'AttributeOptionGroupListView')
        self.attribute_option_group_update_view = get_class('creme_core.dashboard.catalogue.views',
                                                            'AttributeOptionGroupUpdateView')
        self.attribute_option_group_delete_view = get_class('creme_core.dashboard.catalogue.views',
                                                            'AttributeOptionGroupDeleteView')

        self.option_list_view = get_class('creme_core.dashboard.catalogue.views', 'OptionListView')
        self.option_create_view = get_class('creme_core.dashboard.catalogue.views', 'OptionCreateView')
        self.option_update_view = get_class('creme_core.dashboard.catalogue.views', 'OptionUpdateView')
        self.option_delete_view = get_class('creme_core.dashboard.catalogue.views', 'OptionDeleteView')
