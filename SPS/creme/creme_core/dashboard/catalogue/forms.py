...
from ...forms.widgets import DateTimePickerInput, ImageInput
...
ProductSelect = get_class('creme_core.dashboard.catalogue.widgets', 'ProductSelect')
(RelatedFieldWidgetWrapper,
 RelatedMultipleFieldWidgetWrapper) = get_classes('creme_core.widgets',
                                                  ('RelatedFieldWidgetWrapper',
