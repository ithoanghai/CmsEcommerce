...
class Event(models.Model):
    ...
    contacts = models.ManyToManyField(settings.PERSONS_CONTACT_MODEL, blank=True, related_name="event_contact")
    assigned_to = models.ManyToManyField(settings.PERSONS_PROFILE_MODEL, blank=True, related_name="event_assigned" )
    ...
    teams = models.ManyToManyField(settings.PERSONS_TEAM_MODEL, related_name="event_teams")
