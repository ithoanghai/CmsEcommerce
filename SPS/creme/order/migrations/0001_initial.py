...
from ...creme_core.models.fields import autoslugfield, fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', fields.UppercaseCharField(blank=True, max_length=64, verbose_name='Post/Zip-code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now=True, db_index=True, verbose_name='Date')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default=utils.get_default_currency, max_length=12, verbose_name='Currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', fields.autoslugfield.AutoSlugField(blank=True, editable=False, max_length=128, populate_from='name', unique=True, verbose_name='Code')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='event_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='order.shippingeventtype', verbose_name='Event Type'),
        ),
        migrations.AddField(
            model_name='shippingevent',
            name='lines',
        ...
        migrations.AddField(
            ...
            name='event_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='order.paymenteventtype', verbose_name='Event Type'),
        ),
        migrations.AddField(
            model_name='paymentevent',
            name='lines',
