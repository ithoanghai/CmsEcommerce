    ...
    def form_valid(self, form):
        ...
        if self.request.is_ajax():
            data = {
                ...
                "html": render_to_string("app_list/comments/_comment.html", {
                    "comment": self.object
                }, request=self.request)
            }
    ...
    def form_invalid(self, form):
        if self.request.is_ajax():
            data = {
                "status": "ERROR",
                "errors": form.errors,
                "html": render_to_string("app_list/comments/_form.html", {
                    "form": form,
                    "obj": self.content_object
                }, request=self.request)
            }
...
class CommentListView(ListView):
    ...
    template_name = "app_list/comments/comments_list.html"