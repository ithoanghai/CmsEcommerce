...
from ..creme_core.core import prices
...
class OfferDiscount(Base):
    ...
    def code(self):
        """
        Returns the :py:attr:`code <creme.shipping.methods.Base.code>` of the wrapped shipping method.
        """
    ...
    def name(self):
        """
        Returns the :py:attr:`name <creme.shipping.methods.Base.name>` of the wrapped shipping method.
        """
    ...
    def discount_name(self):
        """
        Returns the :py:attr:`name <creme.offer.abstract_models.BaseOfferMixin.name>` of the applied Offer.
        """
