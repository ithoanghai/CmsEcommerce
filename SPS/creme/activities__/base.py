...
class Survey(ActivityType):
    ...
    template_name = "app_list/lms/activities/survey.html"
...
class MultiPageSurvey(Survey):
    ...
    pages = []
    template_name = "app_list/activities/survey.html"
...
class TwoChoiceQuiz(Quiz):
    ...
    template_name = "app_list/activities/two_choice_quiz.html"
    valid_answer = ["left", "right"]


class LikertQuiz(Quiz):

    template_name = "app_list/activities/likert_quiz.html"
...
class TwoChoiceWithAnswersQuiz(QuizWithAnswers):
    ...
    template_name = "app_list/activities/two_choice_with_answers_quiz.html"
    completed_template_name = "app_list/activities/two_choice_with_answers_quiz_completed.html"
    question_template = "app_list/activities/_question.html"
    answer_template = "app_list/activities/_answer.html"
    valid_answer = ["left", "right"]


class TwoChoiceLikertWithAnswersQuiz(QuizWithAnswers):

    template_name = "app_list/activities/two_choice_likert_with_answers_quiz.html"
    completed_template_name = "app_list/activities/two_choice_with_answers_quiz_completed.html"
    question_template = "app_list/activities/_question.html"
...
class ShortAnswerQuiz(Quiz):
    ...
    template_name = "app_list/activities/short_answer_quiz.html"
    completed_template_name = "app_list/activities/short_answer_quiz_completed.html"
    question_template = "app_list/activities/_question.html"
    answer_template = "app_list/activities/_question.html"
...
class MultipleShortAnswerQuiz(Quiz):
    ...
    template_name = "app_list/activities/multiple_short_answer_quiz.html"
    completed_template_name = "app_list/activities/multiple_short_answer_quiz_completed.html"
    question_template = "app_list/activities/_question.html"
    answer_template = "app_list/activities/_question.html"
