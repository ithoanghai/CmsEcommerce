...
class _AssistantSubCell(CustomFormExtraSubCell):
    ...
    def _create_alert(activity, trigger_date, **kwargs):
        ...
        Alert.objects.create(
            ...
            title=_('Alert of activity'),
            description=_('Alert related to {activity}').format(activity=activity),
            **kwargs
        )
...
class UserMessagesSubCell(_AssistantSubCell):
    ...
    def post_save_instance(self, *, instance: AbstractActivity, value, form):
        if value:
            ...
            title = _('[{software}] Activity created: {activity}').format(
                software=settings.SOFTWARE_LABEL,
                activity=instance,
            )
            body = _("""A new activity has been created: {activity}.
    ...
    Participants: {participants}.""").format(
                ...
                start=instance.start or _('not specified'),
                end=instance.end or _('not specified'),
                subjects=' / '.join(
                    str(e)
