...
from ..creme_core.models.base import LogicalDeleteModel


class Announcement(LogicalDeleteModel): # Kế thừa từ LogicalDeleteModeltất cả các kiểu máy mà bạn muốn chia sẻ ở chức năng này.
    """
    ...
    def get_absolute_url(self):
        return reverse("announcements:announcement_detail", args=[self.pk])

    def dismiss_url(self):
        if self.dismissal_type != Announcement.DISMISSAL_NO:
            return reverse("announcements:announcement_dismiss", args=[self.pk])
