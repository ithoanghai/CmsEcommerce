...
class AnnouncementDetailView(DetailView):
    template_name = "app_list/announcements/announcement_detail.html"
    model = Announcement
...
class AnnouncementCreateView(ProtectedView, CreateView):
    template_name = "app_list/announcements/announcement_form.html"
    model = Announcement
...
class AnnouncementDeleteView(ProtectedView, DeleteView):
    template_name = "app_list/announcements/announcement_confirm_delete.html"
    model = Announcement
    success_url = reverse_lazy("announcements:announcement_list")
...
class AnnouncementListView(ProtectedView, ListView):
    template_name = "app_list/announcements/announcement_list.html"
    model = Announcement
