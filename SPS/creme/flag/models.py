...
class FlaggedContent(models.Model):
    ...
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="flagged_content", on_delete=models.CASCADE)
...
class FlagInstance(models.Model):
    ...
    flagged_content = models.ForeignKey(FlaggedContent, on_delete=models.DO_NOTHING)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  # user flagging the content
