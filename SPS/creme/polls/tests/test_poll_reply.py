...
from ...activities.models import ActivitySubType, ActivityType
from ...activities.tests.base import skipIfCustomActivity
from ...creme_core.auth import EntityCredentials
from ...creme_core.forms.fields import GenericEntityField
from ...creme_core.forms.widgets import UnorderedMultipleChoiceWidget
from ...creme_core.models import FieldsConfig, SetCredentials
from ...creme_core.tests.views.base import BrickTestCaseMixin
from ...persons import get_contact_model, get_organisation_model
...
class PollRepliesTestCase(_PollsTestCase, BrickTestCaseMixin):
    ...
    def test_createview02(self):
        ...
        self.assertFormError(
            response.context['form'], field='pform', errors=_('This field is required.'),
        )
    ...
    def test_fillview_bool03(self):
        ...
        self.assertFormError(
            response.context['form'], field='answer', errors=_('The answer is required.'),
        )
