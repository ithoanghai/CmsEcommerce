...
from ...creme_core.gui import bricks as gui_bricks
from ...creme_core.core.entity_cell import (
    EntityCellRegularField,
    EntityCellRelation,
)
from ...creme_core.forms import base
from ...creme_core.forms import fields as core_fields
from ...creme_core.forms.header_filter import EntityCellsField
...
class BrickDetailviewLocationsCreationForm(_BrickDetailviewLocationsForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            role_f.empty_label = '*{}*'.format(_('Superuser'))
