...
class CreatorModelChoiceMixin(CreatorChoiceMixin):
    ...
    def creation_label(self):
        ...
        return getattr(self.queryset.model, 'creation_url', self.widget.creation_url)
        ...
        if decoded_value:
            ...
            for order, entry_dict in enumerate(decoded_value):
                ...
                try:
                    ...
                    self._raise_invalid_data(_('no entry ID'))
                ...
                if (
                    ...
                    self._raise_invalid_data(
                        _('the entry ID "{}" is invalid.').format(entry_id),
                    )
                ...
                try:
                    ...
                    self._raise_invalid_data(
                        _('the entry «{entry}» is invalid ({error})').format(
