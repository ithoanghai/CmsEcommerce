...
class UserCreationForm(CremeModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['role'].empty_label = '*{}*'.format(_('Superuser'))
...
class _TeamForm(CremeModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['username'].label = _('Team name')
...
class UserAssignationForm(CremeForm):
    ...
    def __init__(self, user, instance, *args, **kwargs):
        ...
        to_user.choices = [
            (_('Users'), choices[False]),
            (_('Teams'), choices[True]),
        ]
