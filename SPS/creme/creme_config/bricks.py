...
from ..creme_core.forms import base as core_forms
from ..creme_core import get_world_settings_model
from ..creme_core.core import setting_key
...
from ..creme_core.gui.fields_config import fields_config_registry
...
from ..creme_core.utils.content_type import entity_ctypes
from ..creme_core.utils.string import smart_split
        ...
        class _ExtendedConfigItem:
            def __init__(this, *, item, descriptor, collapsed=True):
                ...
                if item.superuser:
                    ...
                    this.verbose_name = _('Form for role «{role}»').format(role=item.role)
                else:
...
class BrickDetailviewLocationsBrick(PaginatedBrick):
    ...
    def detailview_display(self, context):
        ...
        superusers_label = _('Superuser')  # TODO: cached_lazy_gettext
...
class MenuBrick(_ConfigAdminBrick):
    ...
    def detailview_display(self, context):
        ...
        entries.extend(
            {
                'label':   _('Menu for role «{role}»').format(role=role),
