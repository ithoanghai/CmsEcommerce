...
from ...creme_core.models.history import TYPE_EDITION, HistoryLine
from ...creme_core.tests.base import CremeTestCase
from ...creme_core.tests.fake_bricks import FakeAppPortalBrick
from ...creme_core.tests.views.base import BrickTestCaseMixin
from ...creme_core.utils.translation import get_model_verbose_name
...
class GenericModelConfigTestCase(CremeTestCase, BrickTestCaseMixin):
    ...
    def test_finish_deletor06(self):
        "Not deletor job."
        from ...creme_core.creme_jobs.reminder import reminder_type
