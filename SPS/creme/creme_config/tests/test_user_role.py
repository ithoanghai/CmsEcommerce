...
from ...creme_core.core.entity_filter import (
    EF_CREDENTIALS,
    condition_handler,
    operands,
    operators,
)
from ...creme_core.creme_jobs.deletor import deletor_type
from ...creme_core.forms.base import LAYOUT_REGULAR
from ...creme_core.forms.widgets import Label
from ...creme_core.gui.menu import ContainerEntry, Separator0Entry
from ...creme_core.menu import CremeEntry, JobsEntry
...
from ...creme_core.tests.base import CremeTestCase, skipIfNotInstalled
from ...creme_core.tests.fake_custom_forms import (
    FAKEORGANISATION_CREATION_CFORM,
)
from ...creme_core.tests.views.base import BrickTestCaseMixin
from ...documents.models import Document
from ...persons.models import Address, Contact, Organisation
