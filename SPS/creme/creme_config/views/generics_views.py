...
from ...creme_core.views import bricks as bricks_views
from ...creme_core.core.exceptions import ConflictError
from ...creme_core.creme_jobs.deletor import _DeletorType
from ...creme_core.models import DeletionCommand, Job, JobResult
from ...creme_core.utils.unicode_collation import collator
from ...creme_core.views import generic
from ...creme_core.views.generic.order import ReorderInstances
...
class GenericCreation(ModelConfMixin, generic.CremeModelCreationPopup):
    ...
    def get_title(self):
        ...
        return (
            ...
            _('New value: {model}').format(model=model._meta.verbose_name)
        )
