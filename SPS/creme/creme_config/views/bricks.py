...
from ...creme_core.utils.content_type import get_ctype_or_404
from ...creme_core.views.generic import BricksView
...
class BrickDetailviewLocationsCreation(EntityCTypeRelatedMixin,
    ...
    def get_title(self):
        return _('New block configuration for «{model}»').format(
...
class CustomBrickWizard(base.ConfigModelCreationWizard):
    ...
    class _ConfigStep(bricks_forms.CustomBrickConfigItemEditionForm):
        ...
        @property
        def step_title(self):
            return _('New custom block for «{model}»').format(
