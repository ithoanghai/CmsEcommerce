...
def page(request, slug, binder, *args, **kwargs):
    ...
    try:
        ...
        return render(request, "app_list/wiki/page.html", {"revision": rev, "can_edit": hookset.can_edit_page(page, request.user)})
...
def edit(request, slug, binder, *args, **kwargs):
    ...
    return render(request, "app_list/wiki/edit.html", {
        "form": form,
        "page": page,
        "revision": rev,
