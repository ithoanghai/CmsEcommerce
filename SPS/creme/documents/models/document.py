...
class AbstractDocument(CremeEntity):
    ...
    linked_folder = models.ForeignKey(Folder, verbose_name=_('Folder'), on_delete=models.PROTECT, related_name='folder_document')
    ...
    def get_absolute_url(self):
        return reverse('documents:view_document', args=(self.id,))

    @staticmethod
    def get_create_absolute_url():
        return reverse('documents:create_document')

    def get_edit_absolute_url(self):
        return reverse('documents:edit_document', args=(self.id,))
...
class Document(AbstractDocument):
    ...
    org = models.ForeignKey(Org,on_delete=models.SET_NULL,null=True,blank=True,related_name="document_org",)
