...
class AbstractFolder(CremeEntity):
    ...
    def get_absolute_url(self):
        return reverse('documents:view_folder', args=(self.id,))

    @staticmethod
    def get_create_absolute_url():
        return reverse('documents:create_folder')

    def get_edit_absolute_url(self):
        return reverse('documents:edit_folder', args=(self.id,))

    @staticmethod
    def get_lv_absolute_url():
        return reverse('documents:list_folders')
