...
from ...creme_core.models import FileRef, JobResult
from ...creme_core.models.utils import assign_2_charfield
from ...creme_core.utils import email
from ...creme_core.utils.collections import OrderedSet
...
class _EntityEmailsSyncType(JobType):
    ...
    def results_bricks(self):
        from ...creme_core.bricks import JobResultsBrick
