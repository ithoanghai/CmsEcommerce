...
urlpatterns = [
    ...
    re_path(r"^list/", mail.emails_list, name="emails__list"),
    re_path(r"^compose/", mail.email, name="emails__compose"),
    re_path(r"^email_sent/", mail.email_sent, name="emails__email_sent"),
    re_path(
        r"^email_move_to_trash/(?P<pk>\d+)/$",
        mail.email_move_to_trash,
        name="emails__email_move_to_trash",
    ),
    re_path(r"^email_delete/(?P<pk>\d+)/$", mail.email_delete, name="emails__email_delete"),
    re_path(r"^email_trash/", mail.email_trash, name="emails__email_trash"),
    re_path(
        r"^email_trash_delete/(?P<pk>\d+)/$",
        mail.email_trash_delete,
        name="emails__email_trash_delete",
    ),
    re_path(r"^email_draft/", mail.email_draft, name="emails__email_draft"),
    re_path(
        r"^email_draft_delete/(?P<pk>\d+)/$",
        mail.email_draft_delete,
        name="emails__email_draft_delete",
    ),
    re_path(r"^email_imp/(?P<pk>\d+)/$", mail.email_imp, name="emails__email_imp"),
    re_path(r"^email_imp_list/", mail.email_imp_list, name="emails__email_imp_list"),
    re_path(
        r"^email_sent_edit/(?P<pk>\d+)/$", mail.email_sent_edit, name="emails__email_sent_edit"
    ),
    re_path(r"^email_unimp/(?P<pk>\d+)/$", mail.email_unimp, name="emails__email_unimp"),
    re_path(r"^email_view/(?P<pk>\d+)/$", mail.email_view, name="emails__email_view"),
