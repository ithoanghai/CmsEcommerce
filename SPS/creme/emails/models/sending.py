...
from ...creme_core.utils.crypto import SymmetricEncrypter

from ..utils import EMailSender, ImageFromHTMLError, generate_id
from .mail import ID_LENGTH, AbstractMail
...
class EmailSending(CremeModel):
    ...
    def send_mails(self):
        ...
        try:
            ...
            send_mail(
                _('[{software}] Campaign email sending error.').format(
