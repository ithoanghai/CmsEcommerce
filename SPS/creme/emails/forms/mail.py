...
from ..models import AbstractMail
from ...creme_core.forms import base as core_forms
from ...creme_core.forms import fields as core_fields
from ... import emails, persons
from ...creme_core.auth.entity_credentials import EntityCredentials
from ...creme_core.forms.widgets import CremeTextarea
from ...creme_core.models import FieldsConfig, Relation
from ...creme_core.utils.html import strip_html
...
class EntityEmailForm(core_forms.CremeEntityQuickForm):
    ...
    def _clean_recipients(self, field_name):
        ...
        if bad_entities:
            msg_format = _('The email address for {} is invalid')
            user = self.user
