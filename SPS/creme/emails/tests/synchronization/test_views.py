...
from ....creme_core.models import EntityCredentials, SetCredentials
from ....creme_core.models.file_ref import FileRef
...
class SynchronizationViewsTestCase(BrickTestCaseMixin, _EmailsTestCase):
    DEL_CONF_URL = reverse('emails:delete_sync_config_item')
    ACCEPT_EMAIL_URL = reverse('emails:accept_email_to_sync')
    DEL_EMAIL_URL = reverse('emails:delete_email_to_sync')
    ...
    def test_server_config_creation01(self):
        ...
        url = reverse('emails:create_sync_config_item')
