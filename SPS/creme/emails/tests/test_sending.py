...
from ...creme_core.gui.history import html_history_registry
...
from ...creme_core.models.history import TYPE_AUX_CREATION
...
class SendingConfigTestCase(BrickTestCaseMixin, _EmailsTestCase):
    ...
    def test_creation01(self):
        ...
        url = reverse('emails:create_sending_config_item')
    ...
    def test_creation02(self):
        ...
        response2 = self.client.post(
            reverse('emails:create_sending_config_item'),
            data={
                'name': name,
                'host': host,
                'username': username,
    ...
    def test_creation03(self):
        ...
        self.assertGET403(reverse('emails:create_sending_config_item'))
...
class SendingsTestCase(BrickTestCaseMixin, _EmailsTestCase):
    ...
    def _build_add_url(campaign):
        return reverse('emails:create_sending', args=(campaign.id,))
    ...
    def test_create01(self):
        ...
        response1 = self.assertGET200(reverse('emails:view_lw_mail', args=(mail.id,)))
        ...
        # ---
        response2 = self.assertGET200(reverse('emails:lw_mail_body', args=(mail.id,)))
        ...
        # HTML body ----------------------------------------------------------
        body_url = reverse('emails:sending_body', args=(sending.id,))
        ...
        self.assertBrickHasAction(
            history_brick_node,
            url=reverse('emails:view_lw_mail', args=(contact1_mail.pk,)),
            action_type='view',
        )
    ...
    def test_create02(self):
        ...
        self.assertEqual(
            html1.encode(),
            self.client.get(reverse('emails:lw_mail_body', args=(mail1.id,))).content,
        )
        ...
        self.assertEqual(
            reverse('emails:sending_body', args=(sending.id,)),
            iframe_node1.attrib.get('src'),
        )

        # Email Detail view ----------------------------------------------------
        response3 = self.assertGET200(reverse('emails:view_lw_mail', args=(mail1.id,)))
        ...
        self.assertEqual(
            reverse('emails:lw_mail_body', args=(mail1.id,)),
            iframe_node2.attrib.get('src'),
        )

        # View template --------------------------------------------------------
        response4 = self.assertGET200(reverse('emails:sending_body', args=(sending.id,)))
    ...
    def test_view_lw_email01(self):
        ...
        # List of emails ---
        response = self.assertGET200(reverse('emails:view_sending', args=(sending.id,)))
        self.assertTemplateUsed(response, 'emails/view_sending.html')
        self.assertEqual(sending, response.context.get('object'))

        # Template ---
        self.assertGET200(reverse('emails:sending_body', args=(sending.id,)))

        # Email detail ---
        response = self.assertGET200(reverse('emails:view_lw_mail', args=(lw_mail.id,)))
    ...
    def test_view_lw_email02(self):
        ...
        self.assertGET403(reverse('emails:view_sending', args=(sending.id,)))
        self.assertGET403(reverse('emails:sending_body', args=(sending.id,)))
        self.assertGET403(reverse('emails:view_lw_mail', args=(lw_mail.id,)))
    ...
    def test_reload_sending_bricks01(self):
        ...
        url = reverse('emails:reload_sending_bricks', args=(sending.id,))
    ...
    def test_reload_sending_bricks02(self):
        ...
        self.assertGET403(
            reverse('emails:reload_sending_bricks', args=(sending.id,)),
