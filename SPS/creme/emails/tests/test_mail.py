...
from ...creme_core.models.creme_property import (CremePropertyType,)
from ...creme_core.models.custom_field import (CustomField, FakeInvoice,)
from ...creme_core.models.fields_config import (FieldsConfig,)
from ...creme_core.models.job import (Job,)
from ...creme_core.models.relation import (Relation, RelationType,)
from ...creme_core.models.auth import (SetCredentials,)
from ...creme_core.tests.views.base import BrickTestCaseMixin
from ...documents.models import FolderCategory
...
class EntityEmailTestCase(BrickTestCaseMixin, _EmailsTestCase):
    ...
    def _build_send_from_template_url(entity):
        return reverse('emails:create_email_from_template', args=(entity.id,))

    @staticmethod
    def _build_link_emails_url(entity):
        return reverse('emails:link_emails', args=(entity.id,))
    ...
    def test_createview01(self):
        ...
        # ---
        response3 = self.assertGET200(reverse('emails:view_email', args=(email.id,)))
        ...
        # ---
        response4 = self.assertGET200(reverse('emails:view_email_popup', args=(email.id,)))
    ...
    def test_createview02(self):
        ...
        def create_doc(title, content):
            ...
            response = self.client.post(
                reverse('documents:create_document'), follow=True,
                data={
                    'user':          user.id,
                    'title':         title,
...
'''
    ...
    def test_listview01(self):
        ...
        response = self.assertGET200(reverse('emails:list_emails'))
    ...
    def test_listview_instance_actions(self):
        ...
        self.assertEqual(reverse('emails:resend_emails'), resend_action.url)
    ...
    def test_resend01(self):
        ...
        url = reverse('emails:resend_emails')
