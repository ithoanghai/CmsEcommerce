...
from ...creme_core.core.exceptions import BadRequestError, ConflictError
from ...creme_core.models import Job, Relation
...
from ...emails import get_entityemail_model
from ...emails.constants import UUID_FOLDER_CAT_EMAILS
