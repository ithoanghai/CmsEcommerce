...
from .. import documents, emails, persons
from ..creme_core.gui.bricks import Brick, QuerysetBrick, SimpleBrick
...
class SendingHTMLBodyBrick(_HTMLBodyBrick):
    ...
    def _get_body_url(self, instance):
        return reverse('emails:sending_body', args=(instance.id,))
