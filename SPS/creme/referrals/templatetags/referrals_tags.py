...
@register.inclusion_tag("app_list/referrals/_create_referral_form.html", takes_context=True)
...
class ReferralResponsesNode(template.Node):
    ...
    def render(self, context):
        ...
        qs = settings.REFERRALS_RESPONSES_FILTER_CALLBACK(
            user=user
        )
...
def action_display(value):
    return settings.REFERRALS_ACTION_DISPLAY.get(value, value)
