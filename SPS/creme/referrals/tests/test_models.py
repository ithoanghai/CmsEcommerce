...
class ReferralTests(TestCase):
    ...
    @override_settings(REFERRALS_CODE_GENERATOR_CALLBACK=generate_code_callback)
    ...
    @override_settings(REFERRALS_CODE_GENERATOR_CALLBACK=legacy_generate_code_callback)
