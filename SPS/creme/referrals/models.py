...
class Referral(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.code:
            func = settings.REFERRALS_CODE_GENERATOR_CALLBACK
    ...
    def respond(self, request, action_string, user=None, target=None):
        ...
        ip_address = settings.REFERRALS_GET_CLIENT_IP_CALLBACK(request)
    ...
    def filtered_responses(self):
        return settings.REFERRALS_RESPONSES_FILTER_CALLBACK(
            referral=self
        )
