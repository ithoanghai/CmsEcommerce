...
from ...creme_core.utils.date_period import DatePeriod, date_period_registry

from .base import RecurrentGenerator, RecurrentsTestCase, skipIfCustomGenerator

if apps.is_installed('creme.tickets'):
    from ...tickets import get_ticket_model, get_tickettemplate_model
    from ...tickets.models import Criticity, Priority, Status
    from ...tickets.tests import (
        skipIfCustomTicket,
