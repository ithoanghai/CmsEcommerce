...
from ...creme_core.auth.views import SignupView
from ...persons.models import Organisation, Profile, Contact, Teams
from ...utils.mail import send_email
from ...creme_core.common.serializer import TeamCreateSerializer, TeamsSerializer
...
def autocomplete_users(request):
    ...
    users = CremeUser.objects.exclude(pk__in=[
