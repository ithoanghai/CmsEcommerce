...
from ..creme_core.utils.db import populate_related
...
if apps.is_installed('creme.activities'):
    ...
    from ..activities.constants import NARROW
...
if apps.is_installed('creme.opportunities'):
    from ..opportunities import constants as opp_constants
...
if apps.is_installed('creme.commercial'):
    from ..commercial import constants as commercial_constants
    from ..commercial import get_act_model
