...
class PersonsConfig(CremeAppConfig):
    ...
    def register_field_printers(self, field_printers_registry):
        ...
        #
        # from ...creme_core.gui.field_printers import print_foreignkey_html
        #
    ...
    def hook_user_form(self):
        ...
        from ..creme_config.views.user import UserCreation
    ...
    def register_reports_graph_fetchers(self):
        from ..reports.graph_fetcher_registry import graph_fetcher_registry
