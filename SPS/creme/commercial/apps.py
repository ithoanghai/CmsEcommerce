...
class CommercialConfig(CremeAppConfig):
    ...
    def register_enumerable(self, enumerable_registry):
        from ..creme_core.core import enumerable
    ...
    def hook_activities(self):
        from ..activities import custom_forms as act_cforms
        from ..activities import get_activity_model
        from ..commercial.forms.activity import IsCommercialApproachSubCell
