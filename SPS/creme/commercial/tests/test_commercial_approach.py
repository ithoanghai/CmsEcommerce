...
from ...activities.custom_forms import ACTIVITY_CREATION_CFORM
from ...activities.models import ActivitySubType, Calendar, Status
from ...activities.tests.base import skipIfCustomActivity
from ...creme_core.forms import LAYOUT_REGULAR
...
from ...creme_core.models.history import TYPE_DELETION, HistoryLine
from ...creme_core.tests.base import CremeTestCase
from ...creme_core.tests.fake_models import FakeOrganisation
