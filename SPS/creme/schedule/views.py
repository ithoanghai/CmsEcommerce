...
def schedule_conference(request):
    ...
    return render(request, "app_list/schedule/schedule_conference.html", ctx)
...
def schedule_detail(request, slug=None):
    ...
    return render(request, "app_list/schedule/schedule_detail.html", ctx)
...
def schedule_list(request, slug=None):
    ...
    return render(request, "app_list/schedule/schedule_list.html", ctx)
...
def schedule_list_csv(request, slug=None):
    ...
    response.write(loader.get_template("app_list/schedule/schedule_list.csv").render(Context({
        "presentations": presentations,
...
def schedule_edit(request, slug=None):
    ...
    return render(request, "app_list/schedule/schedule_edit.html", ctx)
...
def schedule_slot_edit(request, slug, slot_pk):
    ...
    if request.method == "POST":
        ...
        return render(request, "app_list/schedule/_slot_edit.html", ctx)
...
def schedule_presentation_detail(request, pk):
    ...
    return render(request, "app_list/schedule/presentation_detail.html", ctx)
...
def session_list(request):
    ...
    return render(request, "app_list/schedule/session_list.html", {
        "sessions": sessions,
    })
...
def session_detail(request, session_id):
    ...
    return render(request, "app_list/schedule/session_detail.html", {
        "session": session,
        "chair": chair,
