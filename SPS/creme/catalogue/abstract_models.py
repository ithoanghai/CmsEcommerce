...
from ..creme_core.core.loading import get_class, get_classes, get_model
from ..creme_core.core.utils import slugify
from ..creme_core.core.validators import non_python_keyword
from ..creme_core.models.fields import AutoSlugField, NullCharField
from ..creme_core.models.fields.slugfield import SlugField
from ..creme_core.utils.models import get_image_upload_path
...
class AbstractProduct(models.Model):
    ...
    date_created = models.DateTimeField(
        _("Date created"), auto_now=True, db_index=True)
