...
from .views import activity, bricks, calendar, staff_dashboard, staff_activity_detail
...
urlpatterns = calendar_patterns + [
    # re_path(r"(?P<key>[\w\-]+)/start/", views.activity_start, name="activities__activity_start"),
    # re_path(r"(?P<key>[\w\-]+)/play/", views.activity_play, name="activities__activity_play"),
    # re_path(r"(?P<key>[\w\-]+)/completed/", views.activity_completed, name="activities__activity_completed"),

    re_path(r"^staff/", staff_dashboard, name="activities__staff_dashboard"),
    re_path(r"^staff/activity/([^/]+)/", staff_activity_detail, name="activities__staff_activity_detail"),
