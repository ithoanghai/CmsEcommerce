...
from ...creme_core.models.deletion import (  # NOQA
    CREME_REPLACE,
    CREME_REPLACE_NULL,
    DeletionCommand,
...
from ...creme_core.models.manager import CremeEntityManager
...
class AbstractActivity(CremeEntity):
    ...
    def get_absolute_url(self):
        return reverse('activities:view_activity', args=(self.id,))

    @staticmethod
    def get_create_absolute_url():
        return reverse('activities:create_activity')

    def get_edit_absolute_url(self):
        return reverse('activities:edit_activity', args=(self.id,))

    @staticmethod
    def get_lv_absolute_url():
        return reverse('activities:list_activities')
