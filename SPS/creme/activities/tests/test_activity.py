...
from ...creme_core.creme_jobs import trash_cleaner_type
from ...creme_core.forms import LAYOUT_REGULAR, ReadonlyMessageField
from ...creme_core.forms.widgets import Label
from ...creme_core.gui import actions
from ...creme_core.gui.custom_form import FieldGroup, FieldGroupList
...
from ...creme_core.utils.date_period import DaysPeriod
...
class ActivityTestCase(_ActivitiesTestCase):
    ADD_UNAVAILABILITY_URL = reverse('activities:create_unavailability')

    @staticmethod
    # def _build_add_related_uri(related, act_type_id=None):
    def _build_add_related_uri(related, type_uuid=None):
        url = reverse('activities:create_related_activity', args=(related.id,))
    ...
    def test_create_view_invalidtype(self):
        self.login_as_root()
        self.assertGET404(reverse('activities:create_activity', args=('invalid',)))
    ...
    def test_popup_view01(self):
        ...
        response = self.assertGET200(
            reverse('activities:view_activity_popup', args=(activity.id,))
        )
    ...
    def test_listviews(self):
        ...
        # Phone calls
        response = self.assertGET200(reverse('activities:list_phone_calls'))
        ...
        # Meetings
        response = self.assertGET200(reverse('activities:list_meetings'))
    ...
    def test_listview_bulk_actions(self):
        ...
        self.assertEqual(reverse('activities:dl_ical'), export_action.url)
    ...
    def test_dl_ical(self):
        ...
        response = self.assertGET200(
            reverse('activities:dl_ical'), data={'id': [act1.id, act2.id]},
        )
