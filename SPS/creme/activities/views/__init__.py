...
from ..models import ActivitySessionState, ActivityState
from ...utils import load_path_attr
from ...creme_core.models.auth import CremeUser
...
class ActivityView(ActivityMixin, View):
    template_name = "app_list/activities/activity.html"
    base_template_name = "app_list/activities/base.html"
...
def staff_dashboard(request):
    ...
    return render(request, "app_list/activities/staff_dashboard.html", {
...
def staff_activity_detail(request, activity_key):
    ...
    return render(request, "app_list/activities/staff_activity_detail.html", {
        "activity_states": activity_states,
        "activity_session_states": activity_session_states,
    })
