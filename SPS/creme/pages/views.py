...
def page(request, path):
    ...
    if page is None:
        if editable:
            return redirect("pages:pages_page_edit", path=path)
        else:
            raise Http404

    return render(request, "app_list/pages/page_detail.html", {
        "page": page,
        "editable": editable,
    })
...
def page_edit(request, path):
    ...
    return render(request, "app_list/pages/page_edit.html", {
        "path": path,
        "form": form
    })
...
def file_index(request):
    ...
    return render(request, "app_list/pages/file_index.html", ctx)
...
def file_create(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("pages:file_index")
    else:
        form = FileUploadForm()
    ...
    return render(request, "app_list/pages/file_create.html", ctx)
