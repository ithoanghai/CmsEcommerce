...
from ..creme_core.core.contants.common import FRIEND_REQUEST_VERB
...
class FindFriendsListView(LoginRequiredMixin, ListView):
    ...
    template_name = "app_list/friends/find-friends.html"
...
class FriendRequestsListView(LoginRequiredMixin, ListView):
    ...
    template_name = "app_list/friends/friend-requests.html"
