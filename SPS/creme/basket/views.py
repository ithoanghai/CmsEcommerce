...
from ..basket.signals import (
    basket_addition, voucher_addition, voucher_removal)
from ..creme_core.core import ajax
from ..creme_core.core.loading import get_class, get_classes, get_model
from ..creme_core.core.utils import is_ajax, redirect_to_referrer, safe_referrer
...
class BasketView(ModelFormSetView):
    ...
    def get_queryset(self):
        """
        Return list of :py:class:`Line <creme.basket.abstract_models.AbstractLine>`
